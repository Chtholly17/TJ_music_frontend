...
<script lang="ts">
import { defineComponent, getCurrentInstance, toRefs, computed, reactive, ComponentInternalInstance } from "vue";
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleClick(row: { id: any; url: any; pic: any; index: any; name: any; lyric: any; }) {
            // playMusic({
            //     id: row.id,
            //     url: row.url,
            //     pic: row.pic,

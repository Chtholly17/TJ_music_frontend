...
export default function () {
  ...
  // 获取歌曲名
  function getSongTitle(str:any) {
    return str.split("-")[1];
  }

  // 获取歌手名
  function getSingerName(str:any) {
    return str.split("-")[0];
  }
  ...
  // 播放
  // function playMusic({ id:any, url, pic, index, name, lyric, currentSongList }) {
